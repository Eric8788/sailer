...
export const WIND_PARTICLE_COUNT = 1200;
export const CURRENT_PARTICLE_COUNT = 800;
export const TRAIL_POOL_SIZE = 180;

export const MINIMAP_SIZE = 200;

export const WIND_ALPHA_BUCKETS = [0.14, 0.22, 0.32];
export const CURRENT_ALPHA_BUCKETS = [0.08, 0.14, 0.2];
